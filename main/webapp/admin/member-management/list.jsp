...
<div class="d-flex">
  ...
  <path d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0M8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m.256 7a4.5 4.5 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10q.39 0 .74.025c.226-.341.496-.65.804-.918Q8.844 9.002 8 9c-5 0-6 3-6 4s1 1 1 1zm3.63-4.54c.18-.613 1.048-.613 1.229 0l.043.148a.64.64 0 0 0 .921.382l.136-.074c.561-.306 1.175.308.87.869l-.075.136a.64.64 0 0 0 .382.92l.149.045c.612.18.612 1.048 0 1.229l-.15.043a.64.64 0 0 0-.38.921l.074.136c.305.561-.309 1.175-.87.87l-.136-.075a.64.64 0 0 0-.92.382l-.045.149c-.18.612-1.048.612-1.229 0l-.043-.15a.64.64 0 0 0-.921-.38l-.136.074c-.561.305-1.175-.309-.87-.87l.075-.136a.64.64 0 0 0-.382-.92l-.148-.045c-.613-.18-.613-1.048 0-1.229l.148-.043a.64.64 0 0 0 .382-.921l-.074-.136c-.306-.561.308-1.175.869-.87l.136.075a.64.64 0 0 0 .92-.382zM14 12.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0"></path>
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/member-management/list.jsp" style="display: none;">
                	회원 관리하기
                </a>
            </li>
            <li class="nav-item">
    ...
    <nav class="navbar navbar-light bg-light" style="width: 500px;">
  		<div class="container">
    		<h4 style="color: blue;">회원 정보 직접 검색하기</h4>
   				 <form class="d-flex" method="post" action="detail.jsp">
   				 <select name="filter" style="height: 40px;">
   				 	<option value="userId">유저 아이디</option>
   				 	<option value="userNickname">유저 닉네임</option>
   				 	<option value="userEmail">유저 이메일</option>
   				 	<option value="userPhoneNumber">유저 연락처</option>
   				 </select>
      			 <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" name="keyword" style="height: 40px;">
      			 <button class="btn btn-outline-success" type="submit" style="height: 40px; width:100px;">검색</button>
   				 </form>
  		</div>
	</nav>
	<br/>
    	...
    	<h1>사이트 이용자 목록</h1>
    	<br/>
    	<h5><mark><strong>수정을 원하는 회원의 아이디를 클릭해 주세요.</strong></mark></h5>
    	<br/>
    	<table class="table table-bordered">
			...
			<tbody>
				<tr>
					<td>1</td>
					<td><a href="detail.jsp?id=xxx" class="link-info">hong</a></td>
					<td>홍길동</td>
